 ...
 * @author Lenovo
 */
public class CategoryManager extends javax.swing.JDialog implements CategoryController {

    /**
     * Creates new form CategoryManager
     */
    public CategoryManager(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        fillToTable();
...
//         TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CategoryManager dialog = new CategoryManager(new javax.swing.JFrame(), true);
   ...
   DefaultTableModel model = (DefaultTableModel) tblCategories.getModel();
    ...
    items = dao.findAll(); // Lấy dữ liệu từ DB
...
//    this.setCheckedAll(true);   
    ...
    for (int i = 0; i < model.getRowCount(); i++) {
        model.setValueAt(true, i, 2); // cột checkbox
    }
    }
...
//    this.setCheckedAll(false);  
     DefaultTableModel model = (DefaultTableModel) tblCategories.getModel();
    for (int i = 0; i < model.getRowCount(); i++) {
        model.setValueAt(false, i, 2); // cột checkbox
    }
    }
