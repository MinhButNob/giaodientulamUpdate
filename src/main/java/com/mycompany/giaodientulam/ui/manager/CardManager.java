...
import com.mycompany.giaodientulam.impl.CardDaoImpl;
 ...
 * @author Lenovo
 */
public class CardManager extends javax.swing.JDialog implements CardC {

    /**
     * Creates new form CardManager
     */
    public CardManager(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(rdoError, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(rdoLose, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CardManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CardManager dialog = new CardManager(new javax.swing.JFrame(), true);
...
public void setForm(Card entity) {
    ...
    switch (status) {
        ...
        case 2:
            ...
            break;
        default:
            // Nếu status không hợp lệ, không chọn gì cả
            rdoOperating.setSelected(false);
...
public Card getForm() {
    ...
    if (rdoOperating.isSelected()) {
        ...
        // Nếu không radio nào được chọn, xử lý mặc định (hoặc ném lỗi tùy yêu cầu)
        entity.setStatus(-1); // hoặc throw new IllegalStateException("No status selected");
    }
